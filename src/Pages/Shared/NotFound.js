...
const NotFound = () => {
	...
	<div class="container flex flex-col items-center justify-center px-5 mx-auto my-8">
		<div class="max-w-md text-center">
			...
			<a rel="noopener noreferrer" href="/" class="px-8 py-3  font-semibold rounded bg-violet-600 text-gray-50"><button className='text-white bg-blue-300 rounded-md p-2'>Back to homepage</button></a>
		</div>
	</div>
</section>
 </>
